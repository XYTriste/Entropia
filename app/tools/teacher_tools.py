...
async def query_teacher_assignments(
    ...
    async with AsyncSessionLocal() as db:
        ...
        ambiguous = [t.name for t in matched_teachers[1:]] if len(matched_teachers) > 1 else []

        # 2. 查询该教师的考试监考安排（ExamTeacher）
